...
public class Snake : MonoBehaviour
{
    ...
    private void Move(Vector3 nextPosition)
    {
        ...
        {
            //у нас есть позиция к которой мы тянемся. А хвост  тянется к нашей позиции а потом хвост стонивится на место головы и  нам нужен tempPosition чтобы знать где он раньше стоял
